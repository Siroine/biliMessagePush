...
def PUSH_test():
    if global_vars.Bark_PushKey:
        print("正在尝试推送Bark...")
        if Bark_PushMSG("白月影Channel 私信了你", "这是一条测试通知，欢迎关注我，立即前往>>", "bilibili://space/8084749",
            ...
            print(
                "如果你收到了Bark的消息推送，那么可能是推送结果解析失败，可能并不会不影响使用。\n")

    if global_vars.SC_PushKey:
        print("正在尝试推送Server酱...")
        if SC_PushMSG('白月影Channel 私信了你',
            ...
            print(
                "如果你收到了Server酱的消息推送，那么可能是推送结果解析失败，可能并不会不影响使用。")
